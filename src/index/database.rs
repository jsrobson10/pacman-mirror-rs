...
use crate::{database::repo::holder::RepoHolder, Index};

impl Index {
    fn send_database(&self, writer: os_pipe::PipeWriter, repo: Arc<RepoHolder>, files: bool) -> anyhow::Result<()> {
    ...
    pub fn get_database(self: &Arc<Self>, repo: Arc<RepoHolder>, files: bool) -> anyhow::Result<Response> {
